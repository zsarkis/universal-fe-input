...
const RULES: IntentPattern[] = [
  ...
  { name: 'next_paragraph', patterns: [/\bnext\s*paragraph\b/, /\bnext\s*para\b/] },
  { name: 'previous_paragraph', patterns: [/\b(?:previous|prev)\s*paragraph\b/, /\b(?:previous|prev)\s*para\b/] },
  { name: 'next', patterns: [/\bnext\b/] },
  { name: 'previous', patterns: [/\bprevious\b/, /\bprev\b/] },
  { name: 'bookmark', patterns: [/\bbookmark\b/, /\bsave\b.{0,10}\b(?:this|it|article|spot|place)\b/] },
