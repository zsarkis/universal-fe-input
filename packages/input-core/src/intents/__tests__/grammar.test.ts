...
describe('resolveIntent', () => {
  const cases: Array<[string, ReturnType<typeof resolveIntent>]> = [
    ...
    ['next paragraph', { name: 'next_paragraph', confidence: 0 }],
    ['next para', { name: 'next_paragraph', confidence: 0 }],
    ['previous paragraph', { name: 'previous_paragraph', confidence: 0 }],
    ['prev paragraph', { name: 'previous_paragraph', confidence: 0 }],
    ['prev para', { name: 'previous_paragraph', confidence: 0 }],
    ['bookmark', { name: 'bookmark', confidence: 0 }],
    ['bookmark this', { name: 'bookmark', confidence: 0 }],
    ['save this', { name: 'bookmark', confidence: 0 }],
    ['save my spot', { name: 'bookmark', confidence: 0 }],
